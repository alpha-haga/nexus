...
**実施内容（完了済み）**:
- Backend:
  - SQL を infrastructure 層に配置（`backend/nexus-infrastructure/src/main/resources/sql/group/group_contract_bank_account.sql`）
...
**次フェーズ**: P2-9（入金情報/対応履歴 API 実装）に着手する。
